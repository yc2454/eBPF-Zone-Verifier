 ...
 *
 * Usage:
 *   test_loader [--type TYPE] <prog.bpf.o> [<bundle.bcf-bundle>]
 *
 ...
 *
 * Iterates ALL programs in the .o (cilium-style multi-program objects),
 * applies the explicit type if given, attaches the bundle to each program,
 * then loads the entire object via libbpf.
 *
...
{
	fprintf(stderr,
		"usage: %s [--type TYPE] <prog.bpf.o> [<bundle.bcf-bundle>]\n",
		prog0);
}
...
int main(int argc, char **argv)
{
	...
	void *bundle = NULL;
	int err = 0, n_progs = 0, n_loaded = 0, argi = 1;
