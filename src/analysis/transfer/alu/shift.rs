...
use crate::zone::domain::{Reg, assume_eq_const, assume_ge_const, assume_le_const, forget, get_bounds};
use crate::ast::{Operand, Width};
use crate::zone::tnum::{Tnum};

use super::helpers::{sync_tnum_to_dbm};

pub(crate) fn handle_shr(
    state: &mut State,
    width: Width,
    dst: Reg,
    src: &Operand,
